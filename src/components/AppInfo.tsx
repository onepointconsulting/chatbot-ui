...
function handleExpandAppInfo() {
  window.localStorage[KEY_EXPAND_APP_INFO] = !window.localStorage[
    KEY_EXPAND_APP_INFO
  ]
    ? 'false'
    : window.localStorage[KEY_EXPAND_APP_INFO] === 'true'
      ? 'false'
      : 'true';
...
export default function AppInfo({
  ...
  return (
    <div className="pr-4 lg:pr-0 h-auto pl-4 md:pl-[3.1rem] lg:pl-[3.6rem] bg-[#339ddf] border-l-4 border-blue-400">
      ...
      <div
        className="flex items-center justify-between w-full py-2 pl-4 pr-2 cursor-pointer"
      ...
      {shouldExpandAppInfo && (
        <div className="w-full [&_img]:open:-rotate-180">
