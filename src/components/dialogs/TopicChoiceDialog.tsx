...
export default function TopicChoiceDialog({socket}: {socket: React.MutableRefObject<Socket | null>}) {
        ...
        <div className="flex flex-col items-center">
          <ul className="w-8/12 md:w-10/12">
            {topics.map((topic: Topic) => (
              <li key={topic.name} className="inline-block w-full md:w-1/2 lg:w-1/3">
