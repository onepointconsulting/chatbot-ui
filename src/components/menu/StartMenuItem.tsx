...
export default function StartMenuItem() {
  ...
  return (
    <>
      <MenuItemTemplate title="Restart" func={processPopup()}>
        <svg
          width="21"
          height="21"
          viewBox="0 0 21 21"
